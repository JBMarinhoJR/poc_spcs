...
-- Caller grants required for executeAsCaller mode
GRANT CALLER USAGE ON WAREHOUSE COMPUTE_WH TO ROLE SPCS_STREAMLIT_APP_ROLE;
GRANT CALLER USAGE ON DATABASE POC_SPCS_DB TO ROLE SPCS_STREAMLIT_APP_ROLE;
GRANT CALLER USAGE ON SCHEMA POC_SPCS_DB.POC_SPCS_SCHEMA TO ROLE SPCS_STREAMLIT_APP_ROLE;
GRANT CALLER SELECT ON TABLE POC_SPCS_DB.POC_SPCS_SCHEMA.APP_DEMO_ORDERS TO ROLE SPCS_STREAMLIT_APP_ROLE;
GRANT CALLER SELECT ON TABLE POC_SPCS_DB.POC_SPCS_SCHEMA.APP_DEMO_USER_REGION_ACCESS TO ROLE SPCS_STREAMLIT_APP_ROLE;
...
GRANT SERVICE ROLE POC_STREAMLIT_SERVICE!ui_role TO ROLE SPCS_DEMO_RLS_ROLE;

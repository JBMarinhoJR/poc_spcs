...
CREATE USER IF NOT EXISTS SPCS_DEMO_ALICE
  PASSWORD = 'Alice#2026Demo!'
  DEFAULT_ROLE = SPCS_DEMO_RLS_ROLE
  MUST_CHANGE_PASSWORD = FALSE;

CREATE USER IF NOT EXISTS SPCS_DEMO_BRUNO
  PASSWORD = 'Bruno#2026Demo!'
  DEFAULT_ROLE = SPCS_DEMO_RLS_ROLE
  MUST_CHANGE_PASSWORD = FALSE;

GRANT ROLE SPCS_DEMO_RLS_ROLE TO USER SPCS_DEMO_ALICE;
...
INSERT OVERWRITE INTO APP_DEMO_USER_REGION_ACCESS (USER_NAME, REGION) VALUES
  ('SPCS_DEMO_ALICE', 'NORTH'),
  ('SPCS_DEMO_ALICE', 'EAST'),
